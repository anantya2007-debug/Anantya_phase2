...
The .tls indicated the presence of a tls callback (i.e., Execute before main / entry0), which meant that the entry point wasn't really where execution started.  
